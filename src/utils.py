...
def print_results_table(results_list: list[dict[str, np.ndarray]], headings: list[str]):
    left_col_size = 25
    other_col_size = 16
...
def plot_gridsearch_scores(grid: GridSearchCV,
    ...
    # example for scoring names: ["accuracy","f1_macro","precision_macro","recall_macro"]
